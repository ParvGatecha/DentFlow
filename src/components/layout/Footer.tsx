    ...
    <footer className="border-t border-slate-200 bg-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-4 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="mb-6 max-w-sm text-sm text-slate-500 leading-relaxed">
              The premier AI WhatsApp assistant designed exclusively for modern dental clinics. Automate communication without overloading your front desk.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-500">
              ...
              <li><Link href="#demo" className="hover:text-brand-600 transition-colors">Book a Demo</Link></li>
        ...
        <div className="mt-16 flex flex-col items-center justify-between border-t border-slate-200 pt-8 sm:flex-row">
          <p className="text-sm text-slate-500">© {new Date().getFullYear()} DentFlow AI. All rights reserved.</p>
          <div className="mt-4 flex items-center gap-2 text-sm text-slate-500 sm:mt-0">
            <Mail size={16} />
            <a href="mailto:hello@dentflow.ai" className="hover:text-brand-600 transition-colors">hello@dentflow.ai</a>
          </div>
        </div>
      </div>
    </footer>
